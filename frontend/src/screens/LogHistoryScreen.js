        ...
        <>
          <div className='table-responsive'>
            <table className='table table-sm hover bordered striped'>
              <thead>
                <tr>
                  <th className='text-danger'>LOG ID</th>
                  <th className='text-danger'>NAME</th>
                  <th className='text-danger'>EMAIL</th>
                  <th className='text-danger'>LOGIN DATE</th>
                  <th className='text-danger'>LOGIN TIME</th>
                </tr>
              </thead>
              <tbody>
                {currentItems &&
          ...
          {logHistory && logHistory.length > itemsPerPage && (
            <div className='d-flex justify-content-center'>
              <ReactPaginate
                ...
                pageLinkClassName='page-link '//ye wala nai h
