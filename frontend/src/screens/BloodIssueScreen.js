  ...
  return (
    <>
              ...
              {loading ? (
                ...
                <form onSubmit={submitHandler}>
                  <div className='row gy-2'>
                    ...
                    <label htmlFor='patient' className='text-danger'>Patient</label>
                        ...
                        (blood) =>
                          ...
                          blood.blood_component.plasma > 0 && (
                            <div className='form-group' key={blood._id}>
                              <label htmlFor='platelet' className='text-danger'>Plasma</label>
                              <select
                                name='plasma'
                                onChange={handleChange}
                                value={values.plasma}
      ...
      <div className='d-flex justify-content-between'>
        ...
        >
          {' '}
          <i className='fas fa-plus'></i> NEW BLOOD ISSUE
        </button>
      </div>
