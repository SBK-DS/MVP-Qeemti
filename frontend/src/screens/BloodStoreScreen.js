  ...
  return (
    <>
                ...
                <form onSubmit={submitHandler}>
                  <div className='row gy-2'>
                    <div className='form-group'>
                      <label htmlFor='donor' className='text-danger'>Donor</label>
                      <input
                        required
                        name='donor'
                    ...
                    <div className='form-group'>
                      <label htmlFor='hb' className='text-danger'>HB</label>
                      <input
                        required
                        name='hb'
                        onChange={handleChange}
                    ...
                    <div className='form-group'>
                      <label htmlFor='blood_component' className='text-danger'>Blood Component</label>
                      <select
                    ...
                    <div className='form-group'>
                      <label htmlFor='unit' className='text-danger'> Unit</label>
                      <input
                        required
                        name='unit'
                        onChange={handleChange}
                    ...
                    <div className='form-group'>
                      <label htmlFor='bag' className='text-danger'>Bag</label>
                      <input
                        required
                        name='bag'
                        onChange={handleChange}
      ...
      <div className='d-flex justify-content-between'>
        ...
        >
          {' '}
          <i className='fas fa-plus'></i>  NEW BLOOD
        </button>
      </div>
            ...
            <table className='table table-sm hover bordered striped'>
              <thead>
                <tr>
                  ...
                  <th className='text-danger'>B. COMPONENT</th>
                  <th className='text-danger'>UNIT</th>
                  <th className='text-danger'>BAG</th>
