              ...
              {loading ? (
                ...
                <form onSubmit={submitHandler}>
                  <div className='row gy-2'>
                    <hr className='mt-0' />
                    <label htmlFor='patient_id' className='text-danger'>Patient ID</label>
                    ...
                    <label htmlFor='patient_name' className='text-danger'>Patient Name</label>
                    <div className='form-group'>
                      <input
                        name='patient_name'
                        onChange={handleChange}
                    ...
                    <label htmlFor='blood_group' className='text-danger'>Blood Group</label>
                    <div className='form-group'>
                      <select
                        name='blood_group'
                        onChange={handleChange}
                    ...
                    <label htmlFor='plasma' className='text-danger'>Plasma</label>
                    <div className='form-group'>
                      <input
                        name='plasma'
                        onChange={handleChange}
                    ...
                    <label htmlFor='platelet' className='text-danger'>Platelet</label>
                    <div className='form-group'>
                      <input
                        name='platelet'
                        onChange={handleChange}
                    ...
                    <label htmlFor='rbc' className='text-danger'>RBC</label>
                    <div className='form-group'>
                      <input
                        name='rbc'
                        onChange={handleChange}
                    ...
                    <label htmlFor='wb' className='text-danger'>Whole Blood</label>
                    <div className='form-group'>
                      <input
                        name='wb'
                        onChange={handleChange}
        ...
        <>
          <div className='table-responsive mt-5'>
            <table className='table table-sm hover bordered striped'>
              <thead>
                <tr>
                  <th className='text-danger'>DATE & TIME</th>
                  <th className='text-danger'>P. ID</th>
                  <th className='text-danger'>P. Name</th>
                  <th className='text-danger'>B. Group</th>
                  <th className='text-danger'>Plasma</th>
                  <th className='text-danger'>Platelet</th>
                  <th className='text-danger'>RBC</th>
                  <th className='text-danger'>W. B</th>
                  <th className='text-danger'>REGISTERER</th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
